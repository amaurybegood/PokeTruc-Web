...
function cardDetailLines(card) {
  ...
  return setLine + traitsLine + releaseLine + cardPriceLine(card);
}

// Mirror of build.js cardPriceLine(): Cardmarket EUR, TCGplayer USD, eBay USD,
// each amount linking to the marketplace page; market + snapshot date in tooltip.
function cardPriceLine(card) {
