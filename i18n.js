...
const translations = {
  en: {
    subtitle:       'Exclusive Pokémon card illustrations tracker',
    dex:            'Pokédex',
    info:           'Info',
  ...
  fr: {
    subtitle:       'Suivi des illustrations exclusives de cartes Pokémon',
    dex:            'Pokédex',
    info:           'Info',
